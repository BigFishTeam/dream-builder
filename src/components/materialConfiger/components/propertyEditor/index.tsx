...
import { Radio, Input, Button, Drawer, Card, Row, Col, Modal } from 'antd';
...
const StateDataViewer: React.FC<{
  ...
  const [states] = useState(astTool.getStateList());
...
const MethodDataViewer: React.FC<{
  ...
  const AjaxModal: React.FC<Partial<{
    ...
    return <Modal visible={visible} onCancel={onCancel} onOk={onOk}></Modal>;
  };
