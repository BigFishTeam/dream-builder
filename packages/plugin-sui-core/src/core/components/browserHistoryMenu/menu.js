        ...
        >
            ...
            <div>
              <span
                className={`submenu-name-active ${
                  collapsed ? 'submenu-name-active-collapsed' : ''
                }`}
              >
                {name}
              </span>
          ...
          <div
            ...
            className={`submenu-list ${
              ...
              menuItemPathList.includes(this.state.currentPath) &&
              !collapsed
                ? ''
                : 'none'
    ...
    return (
      <Link
        ...
        className={`submenu-item-node ${
          this.state.currentPath === path ? 'submenu-item-node-selected' : ''
        }`}
        key={path}
        ...
        {icon && (
          <span
            className={`sui-menu-icon ${
              this.state.currentPath === path ? 'sui-menu-icon-selected' : ''
            }`}
          >
            {icon}
          </span>
        )}
        <span className={collapsed ? 'submenu-item-node-collapsed' : ''}>
          {name}
        </span>
      </Link>
    );
        ...
        {({ allowScroll = true }) => (
          <BrowserRouter>
            <div
              ...
              style={{ height: 'calc(100% - 72px)', overflow: 'hidden' }}
            >
              <div
